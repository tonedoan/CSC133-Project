...
public class Spaceship extends Rescuer {
    ...
    /**
     * This method doesn't do anything since Spaceship does not jump to a location but jumps to 
     * specific opponents.
     */
	@Override
	...
	/**
	 * This method doesn't do anything because Spaceship does not collide with anything.
	 */
	@Override
